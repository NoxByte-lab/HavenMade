...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function initializeAddToCartButtons() {
    if (window.cartListenerInitialized) return;
    window.cartListenerInitialized = true;
  ...
  function showPopup(message, type = "info") {
    ...
    const bgColor =
      type === "success" ? "#4CAF50" : type === "warning" ? "#ff9800" : "#333";
  ...
  document.addEventListener("click", (event) => {
    ...
    if (!name || isNaN(price)) {
      console.warn(
        "⚠️ Skipped adding invalid product (missing name or price).",
      );
      return;
    }
...
const productDescriptions = {
  "Lavender Calm":
    "Soothe your senses with our calming lavender blend. Perfect for evening relaxation and gentle enough for sensitive skin.<br><strong>Net Quantity:</strong> 100g</br>",
  "Aloe & Cucumber":
    "Refresh and hydrate with the cooling duo of aloe vera and cucumber. Ideal for hot days and post-workout freshness.<br><strong>Net Quantity:</strong> 100g",
  "Charcoal Detox":
    "Deep cleanse with activated charcoal that draws out impurities. Great for oily and combination skin types.<br><strong>Net Quantity:</strong> 100g",
  "Rose Petal Bliss":
    "Indulge in luxury with rose petals and shea butter. Leaves skin feeling soft, nourished, and beautifully fragrant.<br><strong>Net Quantity:</strong> 100g",
  "Honey-Oats":
    "Gentle exfoliation meets deep moisturization. Honey and oats work together to soothe and soften even the driest skin.<br><strong>Net Quantity:</strong> 100g",
  "Lemon-Orange":
    "Awaken your senses with the zesty duo of lemon and orange. This citrus burst provides a refreshing start to your day while naturally brightening your skin.<br><strong>Net Quantity:</strong> 100g",
  "Glow & Calm Duo":
    "Indulge in the perfect balance of radiance and relaxation. This exquisite pairing combines our bestselling Rose Bliss for luminous, hydrated skin with the gentle exfoliation of Honey & Oats. Thoughtfully presented in an eco-friendly kraft box that's as beautiful as it is sustainable - perfect for gifting or treating yourself to everyday luxury.<br><strong>Net Quantity:</strong> 100g+100g=200g",
  "Refresh Duo":
  ...
  "Luxe Spa Set":
    "Transform your bathroom into a personal sanctuary. Experience ultimate relaxation with our calming Lavender Calm, nourishing Honey & Oats, and complete the ritual with our elegant Wooden Soap Dish. This curated collection turns everyday bathing into a luxurious spa-like retreat, promoting mindfulness and self-care with every use.<br><strong>Net Quantity:</strong> 100g+100g=200g",
  "Celebration Hamper":
    "The ultimate gift for special moments. This generous collection features 4 assorted soaps carefully selected for variety and luxury, accompanied by a handwritten greeting card and stylish jute pouch. Perfect for birthdays, anniversaries, holidays, or simply celebrating life's beautiful moments with someone special.<br><strong>Net Quantity:</strong> 100g+100g+100g+100g=400g",
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.querySelectorAll(".product-card").forEach((card) => {
    card.addEventListener("click", function (e) {
      ...
      const productName =
        addToCartBtn?.getAttribute("data-name") || "Product Name";
      const productPrice =
        addToCartBtn?.getAttribute("data-price") || "Price not available";
      ...
      const description =
        productDescriptions[productName] || "Product description not available";
  ...
  // Close modal
  document
    .querySelector("#productModal .close")
  ...
  try {
    ...
    const shiprocketResponse =
      await shiprocketPayment.createOrderWithPayment(orderData);
